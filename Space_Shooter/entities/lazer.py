...
class Lazer(Entity):
    def __init__(self, gun, focus_circle, target, touche_enable_aimbot, color=color.red, speed=2000, **kwargs):
        super().__init__(
        ...
        if not (held_keys[touche_enable_aimbot[0]] or held_keys[touche_enable_aimbot[1]]):
